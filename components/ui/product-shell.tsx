...
export function ProductShell({ children }: { children: React.ReactNode }) {
  return (
    <main className="product-shell min-h-dvh">
      ...
      <div className="product-page mx-auto w-full max-w-[1400px] px-5 pb-20 pt-8 sm:px-8 sm:pt-12 lg:px-10 lg:pb-28 lg:pt-16">
        {children}
      </div>
      <footer className="border-t border-black/15 px-5 py-8 sm:px-8 lg:px-10">
