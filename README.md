...
| Resource | Link / Value |
| :--- | :--- |
| **Production URL** | [https://fortech-edu.vercel.app](https://fortech-edu.vercel.app) |
...
1. **Open Fortech:** Visit [https://fortech-edu.vercel.app](https://fortech-edu.vercel.app) (or your local environment at `http://localhost:3000`).
...
Fortech includes **316 automated unit and integration tests** executing via the native Node.js test runner:
...
- **AI Schema & Safety:** Constrained output validation, secret protection, prompt injection resistance, and fallback activation (`lib/ai/service.test.ts`).
...
- [x] **Working Web Product:** Deployed and accessible at [https://fortech-edu.vercel.app](https://fortech-edu.vercel.app)
...
- [ ] **Presentation Deck:** Slide deck (maximum 8 slides PDF)
